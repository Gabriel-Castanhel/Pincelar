      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex gap-3 items-center flex-shrink-0">
            <img src="./logo-cheia.png" alt="Logo" className="w-10 h-10 md:w-12 md:h-12" />
          ...
          <nav className="hidden md:block">
            <ul className="flex gap-8 text-base font-medium font-banner">
              <li><Link href="/" className="hover:text-orange-500 transition-colors">catálogo</Link></li>
              <li><Link href="/artistas" className="hover:text-orange-500 transition-colors">artistas</Link></li>
              <li><Link href="/sobre" className="hover:text-orange-500 transition-colors">sobre</Link></li>
            </ul>
          </nav>
          ...
          <nav className="hidden md:block">
            <ul className="flex gap-6 items-center font-banner">
              ...
              <li>
                <Link href="/login" className="bg-orange-500 text-white px-5 py-2 rounded-full hover:bg-orange-600 transition-all">
                  Login
                </Link>
              </li>
            </ul>
